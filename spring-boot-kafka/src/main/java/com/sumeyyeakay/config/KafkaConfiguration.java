...
public class KafkaConfiguration {
    ...
    @Value("${sumeyyeakay.kafka.address}")
    private String kafkaAddress;

    @Value("${sumeyyeakay.kafka.group.id}")
    private String groupId;



    //Kafkaya baglanmak icin ona bir procuder yani veri saglayici olusturmam gerek
    @Bean
    ...
    //veriyi tuketen - Mesaji key value olarak gonderiyorum.
    @Bean
